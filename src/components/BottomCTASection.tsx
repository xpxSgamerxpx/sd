        ...
        <Section className="bg-dark-gray text-white text-center">
            <FadeIn>
                <h2 className="text-3xl md:text-5xl font-bold mb-2">
                    Partnering with reliablity, <br className="hidden md:inline" />
                    delivering results
                </h2>

                <p className="tracking-widest mb-10">WE SHOW CLIENTS WHAT IS POSSIBLE AND THEN HELP THEM GET THERE</p>
