...
<h2>With Pricing Insight Partners</h2>
        </div>
      </Section>
...
Get your growth back on track, with Pricing Insight Partners.
            ...
            <SlideUp className="bg-white/20 p-10">
                    <h2 className="text-3xl lg:text-5xl font-bold text-center mb-4">Why us&hellip;</h2>
                    <ul className="text-xl">
                        ...
                        <li className="mb-2">
                            <FontAwesomeIcon className="mr-2" icon={faThumbsUp} />
                            Led world-leading consultancies in pricing and monetization.
                        </li>
                        <li className="mb-2">
                            <FontAwesomeIcon className="mr-2" icon={faThumbsUp} />
                            $X,XXX,XXX Revenue Generated 
                        </li>
                        <li>
                            <FontAwesomeIcon className="mr-2" icon={faThumbsUp} />
                            Previously pricing and monetization leaders
                        </li>
                    </ul>
                </SlideUp>
