        ...
        <Section>
            <Grid>
                <FadeIn className="order-2 md:order-1">
                    ...
                    <p className="mb-2">Data Science insights can generate measurable ROI by allowing companies to make better informed decisions, drive operational efficiency, and increase revenue streams. By leveraging the latest in data engineering, machine learning, and cloud-native technologies,  Pricing Insight Partners Consulting helps clients to unlock the full potential of their data and drive sustained business growth.</p>

                    <p><strong>Whether you are just starting on your data science journey or looking to take your existing efforts to the next level,  Pricing Insight Partners Consulting is here to help.</strong></p>
                </FadeIn>
            ...
            <Grid>
                ...
                <FadeIn className="flex flex-col justify-center md:min-h-[500px]">
                    ...
                    <p className="text-xl leading-relaxed">
                        "We are lucky to have the team from  Pricing Insight Partners working alongside our internal team. They are dedicated team members and ready to help however they can. A big thank you for me for their efforts."<br />
